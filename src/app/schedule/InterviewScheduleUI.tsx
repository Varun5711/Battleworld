...
function InterviewScheduleUI() {
  ...
  // Debug state changes
  useEffect(() => {
    console.log('🔍 Processing interviews state changed:', processingInterviews);
  ...
  const handleInterviewResult = async (interview: any, result: 'pass' | 'fail') => {
    ...
    console.log('🔄 Setting processing state for interview:', interview._id, 'Result:', result);
...
✅ We will discuss salary, benefits, and start date
✅ You'll receive your official offer letter soon
✅ Background verification process will begin
✅ Welcome package and onboarding details will follow

📞 WHAT TO EXPECT:
Our HR representative will reach out to you via phone and email to discuss:
• Compensation package and benefits
• Start date and joining formalities
• Required documentation
• Team introduction and orientation schedule
...
PLEASE NOTE:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
• This decision does not reflect your overall capabilities or potential
• We encourage you to apply for future openings that may be a better fit
• We will keep your resume in our talent database for future considerations
• Your interview feedback was positive in many areas
...
🌟 Wishing You Success in All Your Future Endeavors`;
      ...
      console.log('🔄 Updating interview status to:', result === 'pass' ? 'passed' : 'failed');
      ...
      console.log(`✅ Successfully processed ${result.toUpperCase()} for interview ${interview._id}`);
